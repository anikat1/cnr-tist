...
function [] = demo_chickendance_fast_func_numcluster1(resultsoutputdir,inputfile,visfile)
	...
	%Hyperparameter.
        ...
        %lam1=[0.5,2,0.000000005,0.00000002];
        %lam2=[0.000000005,0.00000002];
        maxiter=[300];
        %nbclusters=[2,3,4];
        nbclusters=[2];
        kernels={'original'};
			    ...
			    for lambda_2=lam2
                    ...
                    dlmwrite(affinitymatrixoutputfile,(abs(Z)+abs(Z')));
                     ...
                     for i=1:size(segmentindices,2)-1
                         ...
                         p=patch([startidx endidx endidx startidx],[y1(1),y1(1),y1(2),y1(2)],color);
                     ...
                     color=clustercolor(clusternum)
                     p=patch([xlimit,endidx,endidx,xlimit],[y1(1),y1(1),y1(2),y1(2)],color);
                     p.FaceAlpha=alphaval;
                     ...
                     color=clustercolor(clusternum);
                     p=patch([endidx,xlimit,xlimit,endidx],[y1(1),y1(1),y1(2),y1(2)],color);
                     p.FaceAlpha=alphaval;
