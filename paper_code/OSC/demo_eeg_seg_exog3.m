...
function [] = demo_eeg_seg_exog3_fast(resultsoutputdir,inputfile,laplacefile)
                    ...
                    for beta_1=beta
						...
						if funVal(it)>=0 && vInval==0
                            ...
                            if fV & size(segmentindicesV,2)<=10
                                ...
                                mat2str(lambda_3),'_clusV_',mat2str(nbClusterV))%,'_clusU_',mat2str(nbClusterU));  
